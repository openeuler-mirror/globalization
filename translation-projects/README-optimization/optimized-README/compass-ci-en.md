...
1. Fork upstream-repos repository ([https://gitee.com/wu_fengguang/upstream-repos) ](https://gitee.com/wu_fengguang/upstream-repos %EF %BC %89) and git clone it to the localhost.

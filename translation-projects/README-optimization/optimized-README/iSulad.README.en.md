...
`iSulad` is a lightweight container runtime daemon designed for IOT and Cloud infrastructure. `iSulad` has the characteristics of light, fast and not limited by hardware specifications and architectures, providing a wider range of applications.
...
Or write repository file mannually:
...
This is the iSulad experiment. In this experiment you can install iSulad easily. And then you can pull image, run container, analyse iSulad's performance and compare it with performance of Docker.
